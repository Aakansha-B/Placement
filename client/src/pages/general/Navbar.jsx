...
//               <NavLink to="/" className={({ isActive }) => isActive ? "active text-indigo-600 font-bold" : "text-gray-600"}>
//                 Home
//               </NavLink>
//             </li>
//             <li className="nav-item">
//               <NavLink to="/about" className={({ isActive }) => isActive ? "text-purple-600 fw-semibold border-bottom border-purple-500" : "nav-link text-gray-700" }>
//                 About
//               </NavLink>
//             </li>
//             <li className="nav-item">
          ...
          <ul className="navbar-nav ms-auto align-items-lg-center">
            <li className="nav-item">
              <NavLink
                to="/"
                className={({ isActive }) =>
                  `nav-link text-gray-700 transition-all ${
                    isActive
                      ? "text-purple-600 fw-semibold border-bottom border-purple-500"
            ...
            {!currentUser ? (
              <li className="nav-item ms-3 d-flex gap-2">
                <button
                  className="btn border border-indigo-500 text-indigo-600 hover:bg-red-50"
              ...
              <li className="nav-item dropdown ms-3 position-relative" ref={menuRef}>
                ...
                {menuOpen && (
                  <ul className="dropdown-menu dropdown-menu-end show custom-dropdown">
                    ...
                    <li>
                      <Link
                        className="dropdown-item hover:bg-indigo-50 hover:text-indigo-700"
                        to="/profile"
                      >
                        👤 Profile
                      </Link>
